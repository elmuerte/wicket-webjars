...
import de.agilecoders.wicket.webjars.util.Args;
...
public class WebjarsSettings implements IWebjarsSettings {
	...
	public WebjarsSettings() {
		...
		this.assetPathCollectors = new AssetPathCollector[] { new ClasspathAssetPathCollector(), new VfsAssetPathCollector(),
	...
	public WebjarsSettings useCdnResources(boolean useCdnResources) {
		if (useCdnResources) {
			throw new UnsupportedOperationException("CDN is not supported in this version");
		}
		return this;
	}
	...
	public String toString() {
		return "WebjarsSettings{" + "readFromCacheTimeout=" + readFromCacheTimeout + ", resourceStreamProvider=" + resourceStreamProvider
				+ ", recentVersionPlaceHolder='" + recentVersionPlaceHolder + '\'' + ", assetPathCollectors=" + Arrays.toString(assetPathCollectors)
				+ ", webjarsPackage='" + webjarsPackage + '\'' + ", webjarsPath='" + webjarsPath + '\'' + ", resourcePattern=" + resourcePattern
				+ ", webjarsPathPattern=" + webjarsPathPattern + ", useCdnResources=" + useCdnResources + ", cdnUrl='" + cdnUrl + '\'' + '}';
	}
}
